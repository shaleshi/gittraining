...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>gittraining/linux/test.sh at master · Sadashiv/gittraining · GitHub</title>
...
<meta content="2KlF1m8bID0qxrZjygfDkszP4rL9J4SPY3aVsp4lBlo=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-98ffc71aa2fdddf77bc5c07502bd431663556ad8.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="32c44dcef739ab4f632b714012f5c284">
        ...
        <link data-pjax-transient rel='permalink' href='/Sadashiv/gittraining/blob/fea1270420fe309ef451807942874799d876baec/linux/test.sh'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="https://github.com/login?return_to=%2FSadashiv%2Fgittraining%2Fblob%2Fmaster%2Flinux%2Ftest.sh">Sign in</a>
    </div>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/buildout/linux/test.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="buildout" rel="nofollow" title="buildout">buildout</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/django/linux/test.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="django" rel="nofollow" title="django">django</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/gitolite/linux/test.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="gitolite" rel="nofollow" title="gitolite">gitolite</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/jenkins/linux/test.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="jenkins" rel="nofollow" title="jenkins">jenkins</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/master/linux/test.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/zope_app/linux/test.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="zope_app" rel="nofollow" title="zope_app">zope_app</a>
                </div> <!-- /.select-menu-item -->
            </div>
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="tags">
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/v1.1/linux/test.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.1" rel="nofollow" title="v1.1">v1.1</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:fa3923107359e1db383bacb4bfb3efb4 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:fa3923107359e1db383bacb4bfb3efb4 -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/Sadashiv/gittraining/blob/fea1270420fe309ef451807942874799d876baec/linux/test.sh" data-title="gittraining/linux/test.sh at master · Sadashiv/gittraining · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/Sadashiv/gittraining/raw/master/linux/test.sh" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/Sadashiv/gittraining/blame/master/linux/test.sh" class="button minibutton ">Blame</a>
                  <a href="/Sadashiv/gittraining/commits/master/linux/test.sh" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L9" rel="#L9">9</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="c">#!/bin/sh</span></div><div class='line' id='LC2'><span class="c">#test stmt used for the operator evaluvation</span></div><div class='line' id='LC3'><span class="k">if </span><span class="nb">test</span> <span class="nv">$# </span>-eq <span class="nv">$0</span> ; <span class="k">then</span></div><div class='line' id='LC4'><span class="k">    </span><span class="nb">echo</span> <span class="s2">&quot;Usage: $0 pattern file&quot;</span> &gt;/dev/tty</div><div class='line' id='LC5'><span class="k">elif </span><span class="nb">test</span> <span class="nv">$# </span>-eq 2 ; <span class="k">then</span></div><div class='line' id='LC6'><span class="k">    </span>grep <span class="s2">&quot;$1&quot;</span> <span class="nv">$2</span> <span class="o">||</span> <span class="nb">echo</span> <span class="s2">&quot;$1 not found in the $2&quot;</span> /dev/tty</div><div class='line' id='LC7'><span class="k">else</span></div><div class='line' id='LC8'><span class="k">    </span><span class="nb">echo</span> <span class="s2">&quot;You didn&#39;t enter to arguments&quot;</span></div><div class='line' id='LC9'><span class="k">fi</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.09494s from fe19.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.09536' data-host='fe19'></span>
