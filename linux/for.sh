...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>gittraining/linux/for.sh at master · Sadashiv/gittraining · GitHub</title>
...
<meta content="y+sRnB2dbqdcT/BxC3bPm2YXSzoAIv3ruxq6M7V8WQI=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-98ffc71aa2fdddf77bc5c07502bd431663556ad8.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="32c44dcef739ab4f632b714012f5c284">
        ...
        <link data-pjax-transient rel='permalink' href='/Sadashiv/gittraining/blob/fea1270420fe309ef451807942874799d876baec/linux/for.sh'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="https://github.com/login?return_to=%2FSadashiv%2Fgittraining%2Fblob%2Fmaster%2Flinux%2Ffor.sh">Sign in</a>
    </div>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/buildout/linux/for.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="buildout" rel="nofollow" title="buildout">buildout</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/django/linux/for.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="django" rel="nofollow" title="django">django</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/gitolite/linux/for.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="gitolite" rel="nofollow" title="gitolite">gitolite</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/jenkins/linux/for.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="jenkins" rel="nofollow" title="jenkins">jenkins</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/master/linux/for.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/zope_app/linux/for.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="zope_app" rel="nofollow" title="zope_app">zope_app</a>
                </div> <!-- /.select-menu-item -->
            </div>
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="tags">
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/v1.1/linux/for.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.1" rel="nofollow" title="v1.1">v1.1</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:11ce7f7083d10e7c9f4a76a52ad3e063 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:11ce7f7083d10e7c9f4a76a52ad3e063 -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/Sadashiv/gittraining/blob/fea1270420fe309ef451807942874799d876baec/linux/for.sh" data-title="gittraining/linux/for.sh at master · Sadashiv/gittraining · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/Sadashiv/gittraining/raw/master/linux/for.sh" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/Sadashiv/gittraining/blame/master/linux/for.sh" class="button minibutton ">Blame</a>
                  <a href="/Sadashiv/gittraining/commits/master/linux/for.sh" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L16" rel="#L16">16</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="c">#!/bin/sh</span></div><div class='line' id='LC2'><span class="c">#for.sh--</span></div><div class='line' id='LC3'><span class="nb">set</span> -x</div><div class='line' id='LC4'><span class="k">for </span>file in emp.lst dep.lst;</div><div class='line' id='LC5'><span class="k">do</span></div><div class='line' id='LC6'><span class="k">     </span>cp <span class="nv">$file</span> <span class="k">${</span><span class="nv">file</span><span class="k">}</span>.bak</div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nb">echo</span> <span class="s2">&quot;$file copied to ${file}.bak&quot;</span></div><div class='line' id='LC8'><span class="k">done</span></div><div class='line' id='LC9'><span class="nb">set </span>123 456 789</div><div class='line' id='LC10'><span class="nb">echo</span> <span class="s2">&quot;\$1 is $1, \$2 is $2, \$3 is $3&quot;</span></div><div class='line' id='LC11'><span class="nb">echo</span> <span class="s2">&quot;The $# arguments are $*&quot;</span></div><div class='line' id='LC12'><span class="c">#trap command used to interrupting a program</span></div><div class='line' id='LC13'><span class="c">#debugging set -x[on] set +x[off]</span></div><div class='line' id='LC14'><span class="nb">set</span> +x</div><div class='line' id='LC15'><span class="c">#$0 is program name $1,$2 etc are positional parameters</span></div><div class='line' id='LC16'><span class="c">#$# store the number of argumnets Both $# and $@ contain all arguments but use of $@ is prefered</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.06600s from fe13.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.06640' data-host='fe13'></span>
