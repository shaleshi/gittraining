...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>gittraining/linux/while.sh at master · Sadashiv/gittraining · GitHub</title>
...
<meta content="mn8NOVUy16/VvK3WqsncOi6HSJqkhBFFd/zMK+zMCik=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-98ffc71aa2fdddf77bc5c07502bd431663556ad8.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="32c44dcef739ab4f632b714012f5c284">
        ...
        <link data-pjax-transient rel='permalink' href='/Sadashiv/gittraining/blob/fea1270420fe309ef451807942874799d876baec/linux/while.sh'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="https://github.com/login?return_to=%2FSadashiv%2Fgittraining%2Fblob%2Fmaster%2Flinux%2Fwhile.sh">Sign in</a>
    </div>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/buildout/linux/while.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="buildout" rel="nofollow" title="buildout">buildout</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/django/linux/while.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="django" rel="nofollow" title="django">django</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/gitolite/linux/while.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="gitolite" rel="nofollow" title="gitolite">gitolite</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/jenkins/linux/while.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="jenkins" rel="nofollow" title="jenkins">jenkins</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/master/linux/while.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/zope_app/linux/while.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="zope_app" rel="nofollow" title="zope_app">zope_app</a>
                </div> <!-- /.select-menu-item -->
            </div>
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="tags">
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/v1.1/linux/while.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.1" rel="nofollow" title="v1.1">v1.1</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:b687c96c438bede248f4b68c3d251819 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:b687c96c438bede248f4b68c3d251819 -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/Sadashiv/gittraining/blob/fea1270420fe309ef451807942874799d876baec/linux/while.sh" data-title="gittraining/linux/while.sh at master · Sadashiv/gittraining · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/Sadashiv/gittraining/raw/master/linux/while.sh" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/Sadashiv/gittraining/blame/master/linux/while.sh" class="button minibutton ">Blame</a>
                  <a href="/Sadashiv/gittraining/commits/master/linux/while.sh" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L18" rel="#L18">18</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="c">#!/bin/bash</span></div><div class='line' id='LC2'><span class="c">#while.sh Show the use of while loop</span></div><div class='line' id='LC3'><span class="nb">set</span> -x</div><div class='line' id='LC4'><span class="nv">answer</span><span class="o">=</span>y</div><div class='line' id='LC5'><span class="k">while</span> <span class="o">[</span> <span class="s2">&quot;$answer&quot;</span> <span class="o">=</span> <span class="s2">&quot;y&quot;</span><span class="o">]</span></div><div class='line' id='LC6'><span class="k">do</span></div><div class='line' id='LC7'><span class="k">   </span><span class="nb">echo</span> <span class="s2">&quot;Enter the code and description&quot;</span> &gt;/dev/tty</div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;<span class="nb">read </span>code description</div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;<span class="nb">echo</span> <span class="s2">&quot;$code | $description&quot;</span> &gt;&gt; newlist</div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;<span class="nb">echo</span> <span class="s2">&quot;Enter any mode (y/n):\c&quot;</span> &gt;/dev/tty   </div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;<span class="nb">read </span>anymore</div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;<span class="k">case</span> <span class="nv">$anymore</span> in</div><div class='line' id='LC13'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;y*|Y*<span class="o">)</span> <span class="nv">answer</span><span class="o">=</span>y;;</div><div class='line' id='LC14'><span class="c">#        sleep 60</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;n*|N*<span class="o">)</span> <span class="nv">answer</span><span class="o">=</span>n;;</div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*<span class="o">)</span> <span class="nv">answer</span><span class="o">=</span>y;;</div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">esac</span></div><div class='line' id='LC18'><span class="k">done</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.06493s from fe16.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.06534' data-host='fe16'></span>
