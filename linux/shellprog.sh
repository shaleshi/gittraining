...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>gittraining/linux/shellprog.sh at master · Sadashiv/gittraining · GitHub</title>
...
<meta content="tZFdx9hpvm5cqvk/R8t6MMTSn6X5mynuaLnP8g7+ZGU=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-98ffc71aa2fdddf77bc5c07502bd431663556ad8.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="32c44dcef739ab4f632b714012f5c284">
        ...
        <link data-pjax-transient rel='permalink' href='/Sadashiv/gittraining/blob/fea1270420fe309ef451807942874799d876baec/linux/shellprog.sh'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="https://github.com/login?return_to=%2FSadashiv%2Fgittraining%2Fblob%2Fmaster%2Flinux%2Fshellprog.sh">Sign in</a>
    </div>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/buildout/linux/shellprog.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="buildout" rel="nofollow" title="buildout">buildout</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/django/linux/shellprog.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="django" rel="nofollow" title="django">django</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/gitolite/linux/shellprog.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="gitolite" rel="nofollow" title="gitolite">gitolite</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/jenkins/linux/shellprog.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="jenkins" rel="nofollow" title="jenkins">jenkins</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/master/linux/shellprog.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/zope_app/linux/shellprog.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="zope_app" rel="nofollow" title="zope_app">zope_app</a>
                </div> <!-- /.select-menu-item -->
            </div>
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="tags">
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Sadashiv/gittraining/blob/v1.1/linux/shellprog.sh" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.1" rel="nofollow" title="v1.1">v1.1</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:45219fd1d0b9b9d0ccb94e28b813014a -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:45219fd1d0b9b9d0ccb94e28b813014a -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/Sadashiv/gittraining/blob/fea1270420fe309ef451807942874799d876baec/linux/shellprog.sh" data-title="gittraining/linux/shellprog.sh at master · Sadashiv/gittraining · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/Sadashiv/gittraining/raw/master/linux/shellprog.sh" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/Sadashiv/gittraining/blame/master/linux/shellprog.sh" class="button minibutton ">Blame</a>
                  <a href="/Sadashiv/gittraining/commits/master/linux/shellprog.sh" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L14" rel="#L14">14</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="c">#!/bin/sh</span></div><div class='line' id='LC2'><span class="nb">echo</span> <span class="sb">`</span><span class="nb">pwd</span><span class="sb">`</span> <span class="c">#Print the current working directory</span></div><div class='line' id='LC3'><span class="nb">echo</span> <span class="sb">`</span>date<span class="sb">`</span></div><div class='line' id='LC4'>cal</div><div class='line' id='LC5'><span class="nb">echo</span> <span class="sb">`</span>cal<span class="sb">`</span></div><div class='line' id='LC6'><span class="nb">echo</span> <span class="s2">&quot;Enter the name:\c&quot;</span> <span class="c">#\c no new line</span></div><div class='line' id='LC7'><span class="nb">read </span>name <span class="c">#read is used to take input from the user</span></div><div class='line' id='LC8'><span class="nb">echo</span> <span class="s2">&quot;Enter the file name:\c&quot;</span> <span class="c">#\n new line</span></div><div class='line' id='LC9'><span class="nb">read </span>fname</div><div class='line' id='LC10'><span class="nb">echo</span> <span class="s2">&quot;Search for the name from fname&quot;</span></div><div class='line' id='LC11'>grep <span class="s2">&quot;$name&quot;</span> <span class="nv">$fname</span></div><div class='line' id='LC12'><span class="nb">echo</span> <span class="s2">&quot;Selected records show above&quot;</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'><br/></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.10658s from fe3.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.10703' data-host='fe3'></span>
